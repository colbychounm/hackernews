...
export type CommentFieldsFragment = { __typename?: 'Comment', id: number, by: string, time: number, type: ItemType, text?: string | null, parent: number, kids?: Array<number> | null } & { ' $fragmentName'?: 'CommentFieldsFragment' };

export type JobFieldsFragment = { __typename?: 'Job', id: number, by: string, time: number, type: ItemType, score: number, text?: string | null, title: string, url?: string | null } & { ' $fragmentName'?: 'JobFieldsFragment' };

export type PollFieldsFragment = { __typename?: 'Poll', id: number, by: string, time: number, type: ItemType, descendants: number, kids?: Array<number> | null, parts: Array<number>, score: number, text?: string | null, title: string } & { ' $fragmentName'?: 'PollFieldsFragment' };

export type PollOptFieldsFragment = { __typename?: 'PollOpt', id: number, by: string, time: number, type: ItemType, poll: number, score: number, text?: string | null } & { ' $fragmentName'?: 'PollOptFieldsFragment' };

export type StoryFieldsFragment = { __typename?: 'Story', id: number, by: string, time: number, type: ItemType, text?: string | null, descendants: number, kids?: Array<number> | null, score: number, title: string, url?: string | null } & { ' $fragmentName'?: 'StoryFieldsFragment' };
